...
-- Drop the old user_interests table if it exists and recreate with correct foreign key
DROP TABLE IF EXISTS user_interests CASCADE;

-- Create user_interests table with correct foreign key to users table
